         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <h1 class="banner-title">Explore Rajasthan Palaces</h1>
            ...
            <div class="carousel-item">
              ...
              <h1 class="banner-title">Explore Mysore Palace</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In veritatis quia tempore officia voluptate vero sapiente accusantium exercitationem, non esse! Modi repellendus mollitia recusandae ex vel inventore quod odio repudiandae.</p>
              <button>Explore Now</button>
            </div>
            <div class="carousel-item">
              <img src="images/carousel-3.jpg" class="d-block w-100" alt="...">
              <h1 class="banner-title">Explore South Palaces</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In veritatis quia tempore officia voluptate vero sapiente accusantium exercitationem, non esse! Modi repellendus mollitia recusandae ex vel inventore quod odio repudiandae.</p>
              <button>Explore Now</button>
            </div>
          </div>
...
<h1 class="state-head">Top Palaces to Visit in India</h1>
                 ...
                 <?php
                  ...
                  ?>
                   ...
                   <div class="card-body">
                     ...
                     <a href="palace_details.php?place=<?php echo $row['palace_id'] ?>" class="btn btn-primary">Visit Us</a>
                   </div>
                 </div>
             </div>
    <?php
