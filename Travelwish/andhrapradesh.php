...
<body>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In veritatis quia tempore officia voluptate vero
              sapiente accusantium exercitationem, non esse! Modi repellendus mollitia recusandae ex vel inventore quod
              odio repudiandae.</p>
  ...
  <div class="state">
    <div class="row">
      ...
      $fetch_query = "SELECT * FROM destination WHERE states='Andhra Pradesh' LIMIT $start_from, $per_page_record";
  ...
  <div class="pagination">    
      <?php  
        $query = "SELECT COUNT(*) FROM destination WHERE states='Andhra Pradesh' ";     
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='andhrapradesh.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='andhrapradesh.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='andhrapradesh.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='andhrapradesh.php?page=".($page+1)."'>  Next </a>";   
        }   
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="footer-blog">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum at eos tempora aliquam labore, fuga
              nulla voluptatum dolore quos cum minima repellat quia a ut, repudiandae nesciunt laborum, sit excepturi?
            </p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
  ...
  <script>   
    ...
    {   
        ...
        window.location.href = 'andhrapradesh.php?page='+page;   
    }   
  </script>  
