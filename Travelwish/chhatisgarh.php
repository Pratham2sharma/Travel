...
<div class="state">
    ...
    $fetch_query = "SELECT * FROM destination WHERE states='Chhattisgarh' LIMIT $start_from, $per_page_record";
...
<div class="pagination">    
      <?php  
        $query = "SELECT COUNT(*) FROM destination WHERE states='Chhattisgarh'";
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='chhatisgarh.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='chhatisgarh.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='chhatisgarh.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='chhatisgarh.php?page=".($page+1)."'>  Next </a>";   
        }   
...
<script>   
    ...
    {   
        ...
        window.location.href = 'chhatisgarh.php?page='+page;   
    }   
  </script>  
