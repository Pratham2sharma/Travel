<?php
  ...
  if(isset($_POST["save_data"]))
  {
    ...
    $budget = $_POST["budget"];
      ...
      $stmt = $connection->prepare("INSERT INTO beach(dest_name , description , tip1 , tip2 , tip3 , tip4 , best_time , fileImg ,city , states, budget) 
      VALUES (?, ?, ?,?,?,?,?,?,?,?,?)");
     ...
     if ($stmt->execute()) {
         ...
         header("location: manage_beaches.php");
     } else {
  ...
  if(isset($_POST["click_edit_btn"]))
  {
    ...
    $fetch_query = "SELECT * FROM beach WHERE beach_id='$id'";
  ...
  if(isset($_POST["update_data"]))
  {
    ...
    $update_query = "UPDATE  beach SET dest_name='$place_name', description='$description', tip1='$tip1', tip2='$tip2', tip3='$tip3', tip4='$tip4', best_time='$time_visit', city='$city', states='$state', budget='$budget' WHERE beach_id='$id'";
  ...
  if(isset($_POST['click_delete_btn']))
  {
    ...
    $delete_query = "DELETE FROM beach WHERE beach_id='$id'";
