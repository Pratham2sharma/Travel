  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="insertdataLabel">Insert Mountains</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="insert_mountain.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="updatedata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="insertdataLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="insertdataLabel">Update Mountains</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="insert_mountain.php" method="POST" enctype="multipart/form-data">
      <div class="modal-body">
      <input type="hidden" id="edit_id" name="mountain_id">
        <div class="form-group mb-3">
            <label for="">Destination Title</label>
        ...
        <!--<div class="mb-3">
          ...
          <input class="form-control" type="file" name="fileImg[]" edit="edit_fileImg" accept=".jpg, .jpeg, .png, .webp" multiple required>
        </div>-->
        <div class="form-group mb-3">
            <label for="">City</label>
          ...
          ?>
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center">Manage Mountains</h4>
                ...
                <table class="table table-striped table-brodered table-danger">
                        ...
                        <?php 
                            ...
                            $fetch_query = "SELECT * FROM mountain";
                            ...
                            while($row = mysqli_fetch_assoc($fetch_query_run))
                            {
                              ...
                              ?>
                                        <tr>
                                            <td class="mountain_id"><?php echo $row['mountain_id']; ?></th>
...
$(document).ready(function () {
   $('.delete_btn').click(function (e) {
     ...
     var mountain_id = $(this).closest('tr').find('.mountain_id').text();
       /* console.log('tile_id'); */

       $.ajax({
         method: "POST",
         url: "insert_mounatain.php",
         data: {
...
$(document).ready(function () {
   $('.edit-btn').click(function (e) {
     ...
     var mountain_id = $(this).closest('tr').find('.mountain_id').text();
        console.log(mountain_id); 

       $.ajax({
         method: "POST",
         url: "insert_mountain.php",
         data: {
           'click_edit_btn': true,
           'mountain_id': mountain_id,
         },
