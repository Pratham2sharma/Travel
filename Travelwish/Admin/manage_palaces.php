  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="insertdataLabel">Insert Palaces</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="insert_palace.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="updatedata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="insertdataLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="insertdataLabel">Update Palaces</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="insert_palace.php" method="POST" enctype="multipart/form-data">
      <div class="modal-body">
      <input type="hidden" id="edit_id" name="palace_id">
        <div class="form-group mb-3">
            <label for="">Destination Title</label>
          ...
          ?>
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center">Manage Palaces</h4>
                ...
                <table class="table table-striped table-brodered table-danger">
                        ...
                        <?php 
                            ...
                            $fetch_query = "SELECT * FROM palace";
                            ...
                            while($row = mysqli_fetch_assoc($fetch_query_run))
                            {
                              ...
                              ?>
                                        <tr>
                                            <td class="palace_id"><?php echo $row['palace_id']; ?></th>
...
$(document).ready(function () {
   $('.delete_btn').click(function (e) {
     ...
     var palace_id = $(this).closest('tr').find('.palace_id').text();
       /* console.log('tile_id'); */

       $.ajax({
         method: "POST",
         url: "insert_palace.php",
         data: {
