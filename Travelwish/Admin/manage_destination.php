  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="insertdataLabel">Insert Destionation</h1>
...
<div class="modal fade" id="updatedata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="insertdataLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="insertdataLabel">Update Destionation</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="insert_destination.php" method="POST" enctype="multipart/form-data">
      <div class="modal-body">
      <input type="hidden" id="edit_id" name="place_id">
        <div class="form-group mb-3">
            <label for="">Destination Title</label>
            ...
            <div class="card">
                ...
                <table class="table table-striped table-brodered table-danger">
                        ...
                        <?php 
                            ...
                            $fetch_query = "SELECT * FROM destination";
                            ...
                            while($row = mysqli_fetch_assoc($fetch_query_run))
                            {
                              ...
                              ?>
                                        <tr>
                                            <td class="place_id"><?php echo $row['place_id']; ?></th>
...
$(document).ready(function () {
   $('.delete_btn').click(function (e) {
     ...
     var place_id = $(this).closest('tr').find('.place_id').text();
       /* console.log('tile_id'); */

       $.ajax({
         method: "POST",
         url: "insert_destination.php",
         data: {
