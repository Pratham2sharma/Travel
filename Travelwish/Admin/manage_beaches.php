  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="insertdataLabel">Insert Beaches</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="insert_beach.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="updatedata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="insertdataLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="insert_beach.php" method="POST" enctype="multipart/form-data">
      <div class="modal-body">
      <input type="hidden" id="edit_id" name="beach_id">
        <div class="form-group mb-3">
            <label for="">Destination Title</label>
          ...
          ?>
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center">Manage Beaches</h4>
                ...
                <table class="table table-striped table-brodered table-danger">
                        ...
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($fetch_query_run))
                            {
                              ...
                              ?>
                                        <tr>
                                            <td class="beach_id"><?php echo $row['beach_id']; ?></th>
...
$(document).ready(function () {
   $('.delete_btn').click(function (e) {
     ...
     var beach_id = $(this).closest('tr').find('.beach_id').text();
       /* console.log('tile_id'); */

       $.ajax({
         method: "POST",
         url: "insert_beach.php",
         data: {
