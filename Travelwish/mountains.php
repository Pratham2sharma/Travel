         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <h1 class="banner-title">Explore Mouuntains</h1>
...
<h1 class="state-head">Top Places to Visit in Mountains</h1>
                 ...
                 <?php
                  ...
                  ?>
                   ...
                   <div class="card-body">
                     ...
                     <a href="mountain_detail.php?mountain=<?php echo $row['mountain_id'] ?>" class="btn btn-primary">Visit Us</a>
                   </div>
                 </div>
             </div>
    <?php
