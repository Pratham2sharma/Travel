         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <h1 class="banner-title">Explore Maharashtra</h1>
...
<h1 class="state-head">Top Places to Visit in Maharashtra</h1>
...
<div class="state">
    ...
    $start_from = ($page-1) * $per_page_record;     
        ...
        $fetch_query = "SELECT * FROM destination WHERE states='Maharashtra' LIMIT $start_from, $per_page_record";
...
<div class="pagination">    
      <?php  
        $query = "SELECT COUNT(*) FROM destination WHERE states='Maharashtra' ";     
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='maharashtra.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='maharashtra.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='maharashtra.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='maharashtra.php?page=".($page+1)."'>  Next </a>";   
        }   
