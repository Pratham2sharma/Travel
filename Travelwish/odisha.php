         ...
         <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <h1 class="banner-title">Explore Odisha</h1>
            ...
            <div class="carousel-item">
              ...
              <h1 class="banner-title">Explore Odisha Forts</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In veritatis quia tempore officia voluptate vero sapiente accusantium exercitationem, non esse! Modi repellendus mollitia recusandae ex vel inventore quod odio repudiandae.</p>
              <button>Explore Now</button>
            </div>
            <div class="carousel-item">
              <img src="images/carousel-3.jpg" class="d-block w-100" alt="...">
              <h1 class="banner-title">Explore Odisha Palaces</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In veritatis quia tempore officia voluptate vero sapiente accusantium exercitationem, non esse! Modi repellendus mollitia recusandae ex vel inventore quod odio repudiandae.</p>
              <button>Explore Now</button>
            </div>
          </div>
...
<h1 class="state-head">Top Places to Visit in Odisha</h1>
...
$start_from = ($page-1) * $per_page_record;     
    ...
    $fetch_query = "SELECT * FROM destination WHERE states='Odisha' LIMIT $start_from, $per_page_record";
...
<div class="pagination">    
      <?php  
        $query = "SELECT COUNT(*) FROM destination WHERE states='Odisha' ";     
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='odisha.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='odisha.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='odisha.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='odisha.php?page=".($page+1)."'>  Next </a>";   
        }   
